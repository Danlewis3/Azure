...
$secpasswd = ConvertTo-SecureString "+4tXXKplukb+H59jkMm/CtuDolcIYDOxFLma/ugHtB0=" -AsPlainText -Force
...
Set-AzureRmContext -TenantId 1a92889b-8ea1-4a16-8132-347814051567
